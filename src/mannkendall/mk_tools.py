...
def nanautocorr(obs, nlags, r=0):
    ...
    ###XXX START
    np.savetxt( "DEBUG_mkt_nanautocorr_obs_corr", obs_corr )
    ### XXX END
    ...
    for ind in range(1, nlags+1):
        ...
        obs_2 = obs_corr[:-ind]
        ###XXX START
        np.savetxt( "DEBUG_mkt_nanautocorr_obs_1_ind_"+str(ind), obs_1 )
        np.savetxt( "DEBUG_mkt_nanautocorr_obs_2_ind_"+str(ind), obs_2 )
        ### XXX END
